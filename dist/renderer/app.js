...
(() => {
  ...
  function ToolCallView({ name, args }) {
    ...
    } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { color: "#6EB5FF" } }, "\u25B6"), " Using ", name, Object.keys(args).length > 0 && /* @__PURE__ */ import_react.default.createElement("span", { style: { color: "#666", marginLeft: 8 } }, Object.entries(args).map(([k, v]) => `${k}=${String(v).slice(0, 50)}`).join(", ")));
  }
  function ChatView({ messages }) {
    ...
    if (messages.length === 0) {
      return /* @__PURE__ */ import_react.default.createElement("div", { style: {
        ...
        color: "#555",
        padding: 20
      } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { fontSize: 28, fontWeight: 700, color: "#444", marginBottom: 8 } }, "MauziCode"), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontSize: 14, color: "#555", marginBottom: 20 } }, "Desktop AI Coding Assistant"), /* @__PURE__ */ import_react.default.createElement("div", { style: { fontSize: 13, color: "#444", lineHeight: 2 } }, /* @__PURE__ */ import_react.default.createElement("div", null, "Type a message to start"), /* @__PURE__ */ import_react.default.createElement("div", null, "Ask me to write code, analyze files, or run commands")));
    }
    return /* @__PURE__ */ import_react.default.createElement("div", { style: {
      flex: 1,
      overflowY: "auto",
      ...
      } }, msg.toolCalls?.map((tc, i) => /* @__PURE__ */ import_react.default.createElement(ToolCallView, { key: i, name: tc.name, args: tc.args })), renderContent(msg), msg.isStreaming && /* @__PURE__ */ import_react.default.createElement("span", { style: { animation: "blink 1s infinite", color: "#69DB7C" } }, "|")));
  ...
  function InputBox({ onSend, onAbort, isStreaming }) {
    ...
    return /* @__PURE__ */ import_react2.default.createElement("div", { style: {
    ...
    ), isStreaming ? /* @__PURE__ */ import_react2.default.createElement(
      "button",
      {
        onClick: onAbort,
        style: {
      ...
      "Send"
    )), /* @__PURE__ */ import_react2.default.createElement("div", { style: { fontSize: 11, color: "#444", marginTop: 4, textAlign: "right" } }, "Enter to send \xB7 Shift+Enter for new line"));
  }
  ...
  function Sidebar({ open, onToggle, onNewChat, onOpenSettings, tools }) {
    ...
    return /* @__PURE__ */ import_react4.default.createElement("div", { style: {
      ...
      flexDirection: "column",
      flexShrink: 0
    } }, /* @__PURE__ */ import_react4.default.createElement("div", { style: { padding: "12px", borderBottom: "1px solid #1A1A1A" } }, /* @__PURE__ */ import_react4.default.createElement(
      "button",
      {
        onClick: onToggle,
      ...
      "+ New Chat"
    )), /* @__PURE__ */ import_react4.default.createElement("div", { style: { flex: 1, overflow: "auto", padding: "8px 0" } }, /* @__PURE__ */ import_react4.default.createElement("div", { style: { padding: "4px 12px", fontSize: 11, color: "#555", textTransform: "uppercase", letterSpacing: "0.5px" } }, "Tools"), tools.map((t) => /* @__PURE__ */ import_react4.default.createElement("div", { key: t.name, style: {
      padding: "4px 12px",
      fontSize: 13,
      color: "#888",
      cursor: "default"
    } }, /* @__PURE__ */ import_react4.default.createElement("span", { style: { color: "#6EB5FF" } }, t.name), /* @__PURE__ */ import_react4.default.createElement("div", { style: { fontSize: 11, color: "#555", marginLeft: 12 } }, t.description)))), /* @__PURE__ */ import_react4.default.createElement("div", { style: { padding: "8px 12px", borderTop: "1px solid #1A1A1A" } }, /* @__PURE__ */ import_react4.default.createElement(
      "button",
      {
        onClick: onOpenSettings,
        style: {
  ...
  function SettingsDialog({ onSave, onClose }) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement("div", { style: {
    ...
    ), currentProvider && /* @__PURE__ */ import_react5.default.createElement("div", { style: { fontSize: 11, color: "#555", marginBottom: 20 } }, "Tools: ", currentProvider.supportsTools ? /* @__PURE__ */ import_react5.default.createElement("span", { style: { color: "#69DB7C" } }, "supported") : /* @__PURE__ */ import_react5.default.createElement("span", { style: { color: "#FF6B6B" } }, "not supported"), " | ", "Auth: ", currentProvider.authHeader), /* @__PURE__ */ import_react5.default.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" } }, /* @__PURE__ */ import_react5.default.createElement(
      "button",
      {
        onClick: onClose,
        style: {
      ...
      "button",
      {
        onClick: () => onSave(providerId, apiKey, model, apiBase),
        style: {
          background: "#6EB5FF",
          border: "none",
          borderRadius: 6,
  ...
  function App() {
    ...
    const handleSend = (0, import_react6.useCallback)(async (text) => {
    ...
    const handleSettingsSave = (0, import_react6.useCallback)(async (provider, key, mdl, apiBase) => {
